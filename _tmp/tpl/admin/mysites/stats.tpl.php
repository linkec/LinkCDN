...
// Cache Time:2017-07-03 20:52:57
...
<div id="page-content">
	<div class="panel">
		<div class="panel-heading">
			<form class="panel-control form-inline" onchange="if(this.site_id.value==<?=$site_id?>){location='/admin/mysites/stats/'+this.site_id.value+'/'+this.host.value+'/'+this.period.value;}else{location='/admin/mysites/stats/'+this.site_id.value;}">
...
function get_stats_data(){
	$.getScript('/admin/mysites/stats_data/<?=$site_id?>/<?=$host?>/<?=$period?>/');
}
get_stats_data();
