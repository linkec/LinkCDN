...
// Cache Time:2017-08-29 11:02:29
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg footer-fixed navbar-fixed">
                ...
                <div class="navbar-header">
                    <a href="#" class="navbar-brand">
                        ...
                        <div class="brand-title">
                            <span class="brand-text">管理中心</span>
                        </div>
                    </a>
                </div>
                <!--================================-->
        ...
        <div class="boxed">
            ...
            <div id="content-container">
				<?php require_once template_echo('../admin/'.$mod.'/'.$act.'','tpl/default/'); ?>
            </div>
            
            <!--MAIN NAVIGATION-->
            <!--===================================================-->
            <nav id="mainnav-container" style="position:fixed">
                <div id="mainnav" style="background-color: #6d2626;">
                            ...
                            <div class="nano-content">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li <?=$mod=='mysites' ? 'class="active"' : ''?>>
						                ...
						                <ul class="collapse">
						                    <li <?=$mod=='mysites' && $act=='add' ? 'class="active-link"' : ''?>><a href="/admin/mysites/add">添加域名</a></li>
						                    <li <?=$mod=='mysites' && $act!='add' ? 'class="active-link"' : ''?>><a href="/admin/mysites">域名列表</a></li>
						                </ul>
						            </li>
						            <li <?=$mod=='orders' ? 'class="active"' : ''?>>
						                ...
						                <ul class="collapse">
						                    <li <?=$mod=='orders' && $act=='topup' ? 'class="active-link"' : ''?>><a href="/admin/orders/topup">订单记录</a></li>
											<li <?=$mod=='orders' && $act=='money_log' ? 'class="active-link"' : ''?>><a href="/admin/orders/money_log">购买记录</a></li>
											<li <?=$mod=='orders' && $act=='pay_log' ? 'class="active-link"' : ''?>><a href="/admin/orders/pay_log">消费记录</a></li>
						                </ul>
						            </li>
						            <li <?=$mod=='users' ? 'class="active"' : ''?>>
						                <a href="#">
						                ...
						                <ul class="collapse">
						                    <li <?=$mod=='users' && $act=='list' ? 'class="active-link"' : ''?>><a href="/admin/users/list">用户列表</a></li>
						                </ul>
						            </li>
						            <li <?=$mod=='workorders' ? 'class="active"' : ''?>>
						                ...
						                <ul class="collapse">
											<li <?=$mod=='workorders' && $act!='new' ? 'class="active-link"' : ''?>><a href="/admin/workorders/list">我的工单</a></li>
						                </ul>
						            </li>
						            <li <?=$mod=='nodes' ? 'class="active"' : ''?>>
						                <a href="#">
						                    <i class="ion-ios-list-outline"></i>
						                    <span class="menu-title">
												节点管理
						                ...
						                <ul class="collapse">
											<li <?=$mod=='nodes' && $act=='add' ? 'class="active-link"' : ''?>><a onclick="add_node();">添加节点</a></li>
											<li <?=$mod=='nodes' && $act=='list' ? 'class="active-link"' : ''?>><a href="/admin/nodes/list">节点列表</a></li>
											<li <?=$mod=='nodes' && $act=='task_list' ? 'class="active-link"' : ''?>><a href="/admin/nodes/task_list">任务管理</a></li>
						                </ul>
						            </li>
						            <li <?=$mod=='messages' ? 'class="active-link"' : ''?>>
						                <a href="/admin/messages/home">
		...
		<script>
			function add_node(){
				$.get('/admin/nodes/add',function(html){$('#remoteModal div.modal-content').html(html)});
