...
// Cache Time:2017-05-20 18:51:14
...
<div class="modal-body">
	<div class="panel-body">
		...
		<div class="row">
			<div class="col-lg-6">
				<h2 class="text-warning"><i class="fa fa-cny"></i> <span id="addon_price">50</span></h2>
			</div>
			<div class="col-lg-6">
				<!-- Radio Buttons -->
				<div class="radio">
					<input id="addon_year" class="magic-radio" type="radio" name="days" value="365" onchange="if(this.checked){$('#addon_price').html('500')}">
					<label for="addon_year">年付 （365 天）</label>
				</div>
				<div class="radio">
					<input id="addon_month" class="magic-radio" type="radio" name="days" value="30" checked="" onchange="if(this.checked){$('#addon_price').html('50')}">
