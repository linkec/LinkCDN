...
// Cache Time:2017-09-24 17:25:27
...
<div id="page-content">
	<div class="fixed-fluid">
					            ...
					            <div class="panel-body">
									...
									<h1 class="page-header text-overflow pad-btm" id="cache">缓存设置
										<div class="pull-right">
											<a class="btn btn-danger" onclick="purge_cache('<?=$site['id']?>','<?=$host?>');">缓存清理</a>
										</div>
									</h1>
					                <hr class="hr-sm">
									<fieldset class="">
										<div class="form-group">
											...
											<div class="col-md-1">
												<select class="form-control" name="browser_cache_unit" onchange="suggest_time(this,'browser_cache_time')">
										...
										<div class="form-group">
											...
											<div class="col-md-1">
												<select class="form-control" name="statics_cache_unit" onchange="suggest_time(this,'statics_cache_time')">
											...
											<div class="col-md-1 input-sm">
					                            <input id="statics_cache_anyway" class="magic-checkbox" type="checkbox" name="statics_cache_anyway" <?=ifchecked($host_settings['statics_cache_anyway'],1,'int')?> value="1" >
					                            <label for="statics_cache_anyway">强制缓存</label>
											</div>
											<div class="col-md-1 input-sm">
					                            <input id="statics_cache_ignore" class="magic-checkbox" type="checkbox" name="statics_cache_ignore" <?=ifchecked($host_settings['statics_cache_ignore'],1,'int')?> value="1" >
					                            <label for="statics_cache_ignore">忽略参数</label>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-1">
												<select class="form-control" name="html_cache_unit" onchange="suggest_time(this,'html_cache_time')">
											...
											<div class="col-md-1 input-sm">
					                            <input id="html_cache_anyway" class="magic-checkbox" type="checkbox" name="html_cache_anyway" <?=ifchecked($host_settings['html_cache_anyway'],1,'int')?> value="1" >
					                            <label for="html_cache_anyway">强制缓存</label>
											</div>
											<div class="col-md-1 input-sm">
					                            <input id="html_cache_ignore" class="magic-checkbox" type="checkbox" name="html_cache_ignore" <?=ifchecked($host_settings['html_cache_ignore'],1,'int')?> value="1" >
					                            <label for="html_cache_ignore">忽略参数</label>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-1">
												<select class="form-control" name="index_cache_unit" onchange="suggest_time(this,'index_cache_time')">
											...
											<div class="col-md-1 input-sm">
					                            <input id="index_cache_anyway" class="magic-checkbox" type="checkbox" name="index_cache_anyway" <?=ifchecked($host_settings['index_cache_anyway'],1,'int')?> value="1" >
					                            <label for="index_cache_anyway">强制缓存</label>
											</div>
											<div class="col-md-1 input-sm">
					                            <input id="index_cache_ignore" class="magic-checkbox" type="checkbox" name="index_cache_ignore" <?=ifchecked($host_settings['index_cache_ignore'],1,'int')?> value="1" >
					                            <label for="index_cache_ignore">忽略参数</label>
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">缓存目录</label>
											<div class="col-md-1 input-sm">
					                            <input id="dir_cache_switch" class="magic-checkbox" type="checkbox" name="dir_cache_switch" <?=ifchecked($host_settings['dir_cache_switch'],1,'int')?> value="1" >
					                            <label for="dir_cache_switch">启用</label>
											</div>
											<div class="col-md-1">
												<input class="form-control" value="<?=$host_settings['dir_cache_time']?>" type="text" name="dir_cache_time">
											</div>
											<div class="col-md-1">
												<select class="form-control" name="dir_cache_unit" onchange="suggest_time(this,'dir_cache_time')">
													<option value="s" <?=ifselected($host_settings['dir_cache_unit'],'s','str')?>>秒</option>
													<option value="m" <?=ifselected($host_settings['dir_cache_unit'],'m','str')?>>分</option>
													<option value="h" <?=ifselected($host_settings['dir_cache_unit'],'h','str')?>>时</option>
													<option value="d" <?=ifselected($host_settings['dir_cache_unit'],'d','str')?>>天</option>
												</select>
											</div>
											<div class="col-md-1 input-sm">
					                            <input id="dir_cache_anyway" class="magic-checkbox" type="checkbox" name="dir_cache_anyway" <?=ifchecked($host_settings['dir_cache_anyway'],1,'int')?> value="1" >
					                            <label for="dir_cache_anyway">强制缓存</label>
											</div>
											<div class="col-md-1 input-sm">
					                            <input id="dir_cache_ignore" class="magic-checkbox" type="checkbox" name="dir_cache_ignore" <?=ifchecked($host_settings['dir_cache_ignore'],1,'int')?> value="1" >
					                            <label for="dir_cache_ignore">忽略参数</label>
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">全站缓存</label>
											<div class="col-md-1 input-sm">
					                            <input id="all_cache_switch" class="magic-checkbox" type="checkbox" name="all_cache_switch" <?=ifchecked($host_settings['all_cache_switch'],1,'int')?> value="1" >
					                            <label for="all_cache_switch">启用</label>
											</div>
											<div class="col-md-1">
												<input class="form-control" value="<?=$host_settings['all_cache_time']?>" type="text" name="all_cache_time">
											</div>
											<div class="col-md-1">
												<select class="form-control" name="all_cache_unit" onchange="suggest_time(this,'all_cache_time')">
													<option value="s" <?=ifselected($host_settings['all_cache_unit'],'s','str')?>>秒</option>
													<option value="m" <?=ifselected($host_settings['all_cache_unit'],'m','str')?>>分</option>
													<option value="h" <?=ifselected($host_settings['all_cache_unit'],'h','str')?>>时</option>
													<option value="d" <?=ifselected($host_settings['all_cache_unit'],'d','str')?>>天</option>
												</select>
											</div>
											<div class="col-md-1 input-sm">
					                            <input id="all_cache_anyway" class="magic-checkbox" type="checkbox" name="all_cache_anyway" <?=ifchecked($host_settings['all_cache_anyway'],1,'int')?> value="1" >
					                            <label for="all_cache_anyway">强制缓存</label>
											</div>
											<div class="col-md-1 input-sm">
					                            <input id="all_cache_ignore" class="magic-checkbox" type="checkbox" name="all_cache_ignore" <?=ifchecked($host_settings['all_cache_ignore'],1,'int')?> value="1" >
					                            <label for="all_cache_ignore">忽略参数</label>
											</div>
										</div>
									</fieldset>
									...
									<fieldset>
										...
										<div class="form-group">
											<label class="col-md-2 control-label">基础防护</label>
											<div class="col-md-6 input-sm">
												<div class="col-md-3">
												...
												<div class="col-md-3">
													<input id="safe_header" class="magic-checkbox" name="safe_header" type="checkbox" <?=ifchecked($host_settings['safe_header'],1,'int')?> value="1" >
													<label for="safe_header">安全头</label>
												</div>
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">高级防护</label>
											<div class="col-md-6 input-sm">
												<div class="col-md-3">
													...
													<label for="waf_pro">WAF Pro</label>
												</div>
												<div class="col-md-3">
													...
													<label for="antiddos_pro">Anti-DDOS Pro</label>
												</div>
											</div>
										</div>
									</fieldset>
		...
		function suggest_time(obj,name){
			switch(obj.value){
				case's':
					var time = 300;
					break;
