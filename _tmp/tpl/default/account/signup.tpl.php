...
// Cache Time:2017-05-11 01:00:09
		                ...
		                <div class="row">
		                    <div class="col-sm-12">
		                        <div class="form-group">
									...
									<?php if($sysmsg['email']){ ?><small class="help-block text-danger"><?=$sysmsg['email']?></small><?php } ?>
		                        </div>
		                    </div>
		                    <div class="col-sm-12">
		                        <div class="form-group">
		                            <input type="text" class="form-control" placeholder="手机号码" name="phone" value="<?=$phone?>">
									<?php if($sysmsg['phone']){ ?><small class="help-block text-danger"><?=$sysmsg['phone']?></small><?php } ?>
		                        </div>
		                    </div>
		                    <div class="col-sm-12">
		                        <div class="form-group">
		                            <input type="text" class="form-control" placeholder="用户名" name="username" value="<?=$username?>">
									<?php if($sysmsg['username']){ ?><small class="help-block text-danger"><?=$sysmsg['username']?></small><?php } ?>
		                        </div>
		                    </div>
		                    <div class="col-sm-12">
		                        <div class="form-group">
		                            <input type="password" class="form-control" placeholder="密码" name="password">
									<?php if($sysmsg['password']){ ?><small class="help-block text-danger"><?=$sysmsg['password']?></small><?php } ?>
		                        </div>
							</div>
		                    <div class="col-sm-12">
		                        <div class="form-group">
