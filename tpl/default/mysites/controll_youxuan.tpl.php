					    ...
					    <div class="fluid" style="margin-left:270px;">
					        <div class="panel">
					            <div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-md-6 input-sm">
												...
												<div class="col-md-3">
													...
													<label for="anti_cc_2">脚本模式</label>
												</div>
												<div class="col-md-3">
													<input id="anti_cc_3" class="magic-checkbox" name="anti_cc" type="radio" {#ifchecked($host_settings['anti_cc'],3,'int')#} value="3" >
													<label for="anti_cc_3">验证码模式</label>
												</div>
											</div>
										</div>
										<div class="form-group">
									...
									<fieldset>
										<div class="form-group">
											<label class="col-md-2 control-label">[<a style="cursor:pointer;" onclick="if(this.innerHTML=='全选'){$('.gaosu').prop('checked',true);this.innerHTML='取消'}else{$('.gaosu').prop('checked',false);this.innerHTML='全选'}">全选</a>] 高速线路</label>
											<div class="col-md-6">
												<!--#foreach($nodes[0] as $node){#-->
												<div class="col-md-3 input-sm">
													<input id="node_{$node['id']}" class="magic-checkbox gaosu" type="checkbox" name="nodes[]" {#in_array($node['id'],explode(',',$host_settings['nodes'])) ? 'checked' : ''#} value="{$node['id']}">
										...
										<div class="form-group">
											<label class="col-md-2 control-label">[<a style="cursor:pointer;" onclick="if(this.innerHTML=='全选'){$('.jisu').prop('checked',true);this.innerHTML='取消'}else{$('.jisu').prop('checked',false);this.innerHTML='全选'}">全选</a>] 极速线路</label>
											<div class="col-md-6">
												<!--#foreach($nodes[1] as $node){#-->
												<div class="col-md-3 input-sm">
													<input id="node_{$node['id']}" class="magic-checkbox jisu" type="checkbox" name="nodes[]" {#in_array($node['id'],explode(',',$host_settings['nodes'])) ? 'checked' : ''#} value="{$node['id']}">
													<label for="node_{$node['id']}">{$node['name']}</label>
												</div>
												<!--#}#-->
											</div>
										...
										<div class="form-group">
											<label class="col-md-2 control-label">[<a style="cursor:pointer;" onclick="if(this.innerHTML=='全选'){$('.qijian').prop('checked',true);this.innerHTML='取消'}else{$('.qijian').prop('checked',false);this.innerHTML='全选'}">全选</a>] 旗舰线路</label>
											<div class="col-md-6">
												<!--#foreach($nodes[2] as $node){#-->
												<div class="col-md-3 input-sm">
													<input id="node_{$node['id']}" class="magic-checkbox qijian" type="checkbox" name="nodes[]" {#in_array($node['id'],explode(',',$host_settings['nodes'])) ? 'checked' : ''#} value="{$node['id']}">
													<label for="node_{$node['id']}">{$node['name']}</label>
												</div>
												<!--#}#-->
											</div>
