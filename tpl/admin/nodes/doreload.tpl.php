    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg footer-fixed navbar-fixed">
        ...
        <div class="boxed">
            <div id="content-container">
							...
							<div class="pad-btm form-inline">
								<div class="row">
									<div class="col-sm-6 table-toolbar-left">
										...
										<a class="btn btn-purple disabled" href="/nodes/doreload">开始</a>
									</div>
								</div>
							</div>
							<div id="reload_console" style="height:500px;background: #263238;color: white;padding: 20px;overflow-y:scroll;">
				...
				<!-- END MAIN CONTENT -->
				<script>
				function run_echo(str){
					$('#reload_console').append(str+'<br>');
					$('#reload_console').scrollTop(10000000);
				}
				</script>
            </div>
                            ...
                            <div class="nano-content">
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li {#$mod=='settings' ? 'class="active"' : ''#}>
						                ...
						                <ul class="collapse">
						                    <li {#$mod=='settings' && $act=='profile' ? 'class="active-link"' : ''#}><a href="/settings/profile">用户列表</a></li>
						                </ul>
						            </li>
						            ...
						            <li {#$mod=='nodes' ? 'class="active"' : ''#}>
						                ...
						                <ul class="collapse">
											<li {#$mod=='nodes' && $act=='add' ? 'class="active-link"' : ''#}><a href="/nodes/add">添加节点</a></li>
											<li {#$mod=='nodes' && $act=='list' ? 'class="active-link"' : ''#}><a href="/nodes/list">节点列表</a></li>
						                </ul>
						            </li>
