...
<head>
    ...
    <title>睿速管理中心 - 天津随客网络科技有限公司版权所有 @2017</title>
		    ...
		    <div class="cls-content-sm panel">
		        <div class="panel-body">
		            <div class="mar-ver pad-btm">
		                <h3 class="h4 mar-no">RayCDN Admin</h3>
		                <p class="text-muted">登录到管理中心</p>
		            </div>
		            <form id="login-form" action="/account/signin">
						<input type="hidden" name="task" value="login">
						<input type="hidden" name="formhash" value="{$formhash}">
		                <div class="form-group">
		                    <input type="text" class="form-control" placeholder="帐号" autofocus name="email">
		                </div>
		                <div class="form-group">
