...
<div id="page-content">
	<div class="row">
		<div class="col-md-3 mar-btm">
			...
			<!--===================================================-->
			<div class="pad-top">
				<a href="https://www.raycdn.com/mysites" class="btn btn-primary">立刻为我的域名启用 WAF PRO</a>
			</div>
			<!--===================================================-->
					...
					<div class="pad-ver mar-ver">
						...
						<div class="pad-ver mar-ver">
							...
							<div id="demo-gen-faq5" class="mar-ver collapse in">
								我们为所有用户免费提供WAF基础版（90% 拦截能力）；WAF PRO 则按照域名收费，200元/域名/月，为某一个域名购买 WAF PRO 后，此域名下的所有子域名均可以免费开启 WAF PRO ；本功能由于涉及到双中间源布置以及边缘节点重构，所以需要先购买后才能启用，不支持按用量计费。
							</div>
						</div>
						<div class="pad-ver mar-ver">
