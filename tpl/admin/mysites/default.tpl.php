			...
			<div class="pad-btm form-inline">
				<div class="row">
					<div class="col-sm-6 table-toolbar-left">
						<a class="btn btn-purple" href="/admin/mysites/add"><i class="demo-pli-add"></i> 添加域名</a>
					</div>
					...
					<tbody>
						...
						<tr id="site_{$v['id']}">
							...
							<td style="width:200px;" class="site_status">
								...
								<!--#}elseif($v['status']=='pendding'){#-->
									等待配置主机名
								<!--#}#-->
							</td>
							<td style="width:150px;" class="text-right">
								<!--#if($v['status']=='success'){#-->
								<a class="btn btn-primary" href="/admin/mysites/records/{$v['id']}"><i class="fa fa-sitemap"></i> 域名解析 </a>
								<a class="btn btn-primary" href="/admin/mysites/controll/{$v['id']}"><i class="fa fa-cog"></i> 控制面板 </a>
								<a class="btn btn-primary" href="/admin/mysites/stats/{$v['id']}"><i class="fa fa-bar-chart-o"></i> 统计报表 </a>
								<!--#}elseif($v['status']=='pendding'){#-->
								<a class="btn btn-warning" href="/admin/mysites/add_2/{$v['id']}"><i class="fa fa-forward"></i> 继续接入</a>
								<a class="btn btn-primary" href="/admin/mysites/records/{$v['id']}"><i class="fa fa-sitemap"></i> 域名解析 </a>
								<!--#}elseif($v['status']=='wait_verify'){#-->
